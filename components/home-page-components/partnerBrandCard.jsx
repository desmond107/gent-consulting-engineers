...
const PartnerBrandCard = ({ title, src, alt }) => {
  return (
    <div className="partner-logo flex justify-center items-center gap-2 grayscale opacity-75 transition-all duration-300 hover:grayscale-0 hover:opacity-100">
