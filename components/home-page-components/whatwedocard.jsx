const WhatWeDoCard = ({ icon, iconSrc, iconAlt, title, desc, index }) => {
  return (
    <div className="group relative h-full bg-white rounded-xl p-7 flex flex-col gap-4 border border-black/5 shadow-card transition-all duration-300 hover:-translate-y-1 hover:shadow-lift">
      <div className="flex items-start justify-between">
        ...
        {index ? (
          <span className="font-display text-sm font-semibold text-ink-muted/60">
